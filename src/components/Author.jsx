    ...
    <div className="flex flex-col justify-center p-6 shadow-md rounded-xl sm:px-12">
      ...
      <div className="space-y-4 text-center divide-y divide-gray-700">
        <div className="my-2 space-y-1">
          ...
          <p className="px-5 text-xs sm:text-base">User Name: {username}</p>
        </div>
        <div className="flex justify-center pt-2 space-x-4 align-center">
          <a
            target="_blank"
            href={`https://www.github.com/${github_username}`}
            aria-label="GitHub"
          ...
          <a
            ...
            className={` ${
              twitter_username
                ? "p-2 rounded-md hover:text-violet-400"
                : "hidden"
            }`}
          >
            <svg
